...
<div class="modal fade" id="notifSetting" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="notifSettingLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="container-fluid">
                    <div class="btn btn-block btn-outline-warning waves-effect settingSelesai" data-id="<?php echo e($ljkh->id_ljkh); ?>">Selesai</div>
                </div>
            </div>
        </div>
    </div>
...
</template><?php /**PATH C:\projek\resources\views/member/modal.blade.php ENDPATH**/ ?>