...
$(document).ready(function () {
    ...
    //             'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    //         },
    //         url: "<?php echo e(route('project.getData')); ?>",
    //         type: "GET",
    //     },
    //     columns: [
    ...
    $('.tombol-simpan').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // table.ajax.reload();
                $('#table-index').load('<?php echo e(route('project.index')); ?> #table-index > *');
    ...
    //         $.get("<?php echo e(route('project.index')); ?>", function(data) {
    ...
    $('.tombol-update').click(function () {
        ...
        $.ajax({
            ...
            data: updateData,
            url: "<?php echo e(route('project.update', ':id')); ?>".replace(':id', project_id),
            type: "PUT",
            dataType: 'json',
    ...
    //     $.get("<?php echo e(route('project.edit', ':id')); ?>".replace(':id', project_id), function (data) {
    //         $('#projectForm').trigger("reset");
    ...
    $('body').on('click', '.deleteProject', function () {
        Swal.fire({
            ...
            if(result.isConfirmed) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "<?php echo e(route('project.destroy', ':id_project')); ?>".replace(':id_project', project_id),
                    data: {
    ...
    //                 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    //             },
    //             url: "<?php echo e(route('project.importProject')); ?>",
    //             type: "POST",
    //             data: formData,
    //             contentType: false,
    //             processData: false,
...
<?php /**PATH C:\projek\resources\views/admin/script.blade.php ENDPATH**/ ?>