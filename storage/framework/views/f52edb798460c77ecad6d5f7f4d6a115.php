...
<script>
    ...
    $(document).ready(function () {
        var tableValidasi = $('#table-validasi').DataTable({
            ...
            // },
            pageLength: 3,
            ajax: "<?php echo e(route('foreman.ListValidasiJob')); ?>",
            columns: [
        ...
        var tableValidated = $('#table-validated').DataTable({
            ...
            serverSide: true,
            pageLength: 10,
            ajax: "<?php echo e(route('foreman.jobValidated')); ?>",
            columns: [
                { data: 'DT_RowIndex', name: 'DT_RowIndex' },
        ...
        $('body').on('click', '.validasiProject', function () {
            ...
            $.get("<?php echo e(route('foreman.showValidasiJob', ':id_jobList')); ?>".replace(':id_jobList', project_id), function (data) {
        ...
        $('#btnValidasi').click(function (e) {
            ...
            if (checkboxes.length === 0|| checkboxes.length !== 2) {
                ...
                $.ajax({
                    ...
                    data: validasiData,
                    url: "<?php echo e(route('foreman.validasiJob', ':id_jobList')); ?>".replace(':id_jobList', project_id),
                    type: "PUT",
                    dataType: 'json',
        ...
        $(document).on('click','.priority', function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('foreman.priorityJob', ':id_jobList')); ?>".replace(':id_jobList', rowId),
                type: "POST",
                data: {
                    priority: priority
                },
...
<?php /**PATH C:\projek\resources\views/foreman/script.blade.php ENDPATH**/ ?>