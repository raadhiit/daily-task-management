            ...
            <div class="row mt-3 pl-4 pb-3">
                <div class="col-sm-2">
                    ...
                    <select class="form-control form-control-sm select2" id="tahun" name="tahun" aria-controls="filter_tahun" style="width: 100%">
                        <?php for($i = \Carbon\Carbon::now()->format('Y'); $i > \Carbon\Carbon::now()->format('Y') - 5; $i--): ?>
                            <option value="<?php echo e($i); ?>" <?php if($i == $selectedYear): ?> selected="selected" <?php endif; ?>><?php echo e($i); ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
                <div class="col-sm-2">
                    ...
                    <select class="form-control form-control-sm select2" name="bulan" id="bulan" aria-controls="filter_bulan" style="width: 100%">
                        <?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $monthFormatted = str_pad($month, 2, '0', STR_PAD_LEFT); ?>
                            <option value="<?php echo e($monthFormatted); ?>" <?php if($monthFormatted == $selectedMonth): ?> selected="selected" <?php endif; ?>>
                                <?php echo e(\Carbon\Carbon::createFromFormat('m', $monthFormatted)->format('F')); ?>
                ...
                <div class="col-sm-2">
                    ...
                    <select name="status" id="status" class="custom-select custom-select-sm">
                        <option value="Complete" <?php if($selectedStatus == 'Complete'): ?> selected="selected" <?php endif; ?>>Complete</option>
                        <option value="In progress" <?php if($selectedStatus == 'In progress'): ?> selected="selected" <?php endif; ?>>In progress</option>
                        <option value="ready" <?php if($selectedStatus == 'ready'): ?> selected="selected" <?php endif; ?>>ready</option>
                    </select>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="text-center">
                                    <td><?php echo e($project); ?></td>
                                    <td><?php echo e($details['targetHour']); ?></td>
                                    <td><?php echo e($details['W1']); ?></td>
                                    <td><?php echo e($details['W2']); ?></td>
                                    <td><?php echo e($details['W3']); ?></td>
                                    <td><?php echo e($details['W4']); ?></td>
                                    <td><?php echo e($details['totalHours']); ?></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#display').click(function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.DashboardAdmin')); ?>",
                    type: 'GET',
                    data: {
                        param1: tahun,
                        param2: bulan,
            ...
            $('#generate-pdf').click(function(e) {
                ...
                window.location.href = "<?php echo e(route('download.pdf')); ?>" + "?param1=" + tahun + "&param2=" + bulan + "&param3=" + status;
            });
        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projek\resources\views/admin/DashboardAdmin.blade.php ENDPATH**/ ?>